...
export default function OnboardingCallbackPage() {
  ...
  return (
    <div className="min-h-screen bg-auriga-bg-subtle flex items-center justify-center p-4">
      <div className="bg-white rounded-2xl border border-auriga-border p-8 shadow-sm text-center max-w-md w-full">
        ...
        {(phase === 'checking' || phase === 'verifying' || phase === 'completing') && (
          <>
            <div className="w-14 h-14 mx-auto mb-5 rounded-full bg-auriga-accent/15 flex items-center justify-center">
              <svg className="w-6 h-6 animate-spin text-auriga-text-primary" viewBox="0 0 24 24" fill="none">
        ...
        {phase === 'failed' && (
          <>
            <div className="w-14 h-14 mx-auto mb-5 rounded-full bg-auriga-error/10 flex items-center justify-center">
              <svg className="w-7 h-7 text-auriga-error" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
                <path strokeLinecap="round" strokeLinejoin="round" d="M6 18L18 6M6 6l12 12" />
              </svg>
            </div>
            <h1 className="text-xl font-semibold mb-2">Verification unsuccessful</h1>
            <p className="text-sm text-auriga-text-secondary mb-6">
