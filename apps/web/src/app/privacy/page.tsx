...
export const metadata = { title: 'Privacy Policy — Auriga' };
    ...
    <div className="min-h-screen bg-auriga-bg-subtle py-16">
      <Container className="max-w-2xl">
        ...
        <div className="bg-white rounded-2xl border border-auriga-border/70 p-8 space-y-6 text-sm text-auriga-text-secondary leading-relaxed">
          <section>
            <h2 className="text-base font-medium text-auriga-text-primary mb-2">Data We Collect</h2>
          ...
          <section>
            <h2 className="text-base font-medium text-auriga-text-primary mb-2">How We Use Your Data</h2>
          ...
          <section>
            <h2 className="text-base font-medium text-auriga-text-primary mb-2">Data Sharing</h2>
          ...
          <section>
            <h2 className="text-base font-medium text-auriga-text-primary mb-2">Your Rights</h2>
            <p>Under GDPR, you have the right to access, correct, delete, or export your personal data. You can exercise these rights by contacting privacy@aurigamoney.com or through your account settings.</p>
          </section>
          <section>
            <h2 className="text-base font-medium text-auriga-text-primary mb-2">Data Security</h2>
          ...
          <section>
            <h2 className="text-base font-medium text-auriga-text-primary mb-2">Cookies</h2>
