    ...
    <section className="py-24 sm:py-36 bg-white">
      <Container>
        ...
        <Reveal direction="scale" className="max-w-2xl mx-auto">
          <div className="bg-white rounded-3xl border border-atlas-border p-8 sm:p-10 shadow-[0_24px_60px_-32px_rgba(0,0,0,0.25)] text-left">
            <div className="flex items-center justify-between mb-6 pb-6 border-b border-atlas-border">
              <div>
                <h3 className="text-xl font-bold text-atlas-text-primary tracking-tight">Atlas Business</h3>
                <p className="text-sm text-atlas-text-secondary">Everything you need to operate globally</p>
              </div>
              <div className="text-right">
                <p className="text-4xl font-bold text-atlas-text-primary tracking-tight">€0</p>
            ...
            <div className="grid sm:grid-cols-2 gap-x-6 gap-y-3.5 mb-8">
              {[
                ...
                <div key={feature} className="flex items-center gap-2.5 text-sm text-atlas-text-primary">
