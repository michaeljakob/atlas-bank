...
function AtlasCard() {
  return (
    <div className="relative aspect-[1.586/1] w-full rounded-2xl bg-atlas-black p-5 overflow-hidden shadow-[0_24px_60px_-12px_rgba(0,0,0,0.55)] ring-1 ring-white/10">
      {/* soft sheen */}
            ...
            <div className="mt-10 flex items-center gap-4">
              <div className="flex -space-x-3">
                ...
                <img
                  ...
                  loading="eager"
                />
                <div className="w-11 h-11 rounded-full ring-2 ring-white shadow-md bg-atlas-black text-white flex items-center justify-center text-[11px] font-bold">
                  50K+
                </div>
              </div>
              <div>
                <span className="sr-only">Rated 5 out of 5 stars</span>
                <div className="flex items-center gap-0.5 text-atlas-black" aria-hidden="true">
                ...
                <p className="mt-0.5 text-sm text-atlas-text-secondary">
                  <span className="font-semibold text-atlas-text-primary">Loved by 50,000+</span> Europeans across 20+ countries
                </p>
              </div>
            </div>
          </Reveal>
